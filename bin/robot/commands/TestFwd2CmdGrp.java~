 ...
 *
 */
public class TestFwd2CmdGrp extends CommandGroup {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public TestFwd2CmdGrp() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
    	...
    	addSequential(new DriveFwd2Cmd		(  6.0,      0.8,    0.0,     1,    3.0));
    	
    	//				  DriveArcTurnCmd( leftPwr, rightPwr, dist, hdg, mode, TO)
    	addSequential(new DriveArcTurnCmd(   0.8,      0.2,     0,   -40,   1,   5));
    	
    	// 			      				 	(tgtDist,    Pwr,     Hdg,   Mode,   TO)
    	addSequential(new DriveFwd2Cmd		(  29.0,      0.8,    -40.0,     1,    3.0));
