...
public class Logger extends Subsystem { 
    ...
    public void createFile(){
    	...
    	last = new String(base + "30.csv"); 
    	lastFile = new File(last);
	    System.out.println("attempting log30.csv delete");
   		bool = lastFile.delete();
   		if (bool)
   		    System.out.println("log30.csv delete SUCCESS");
   		else
   		    System.out.println("NO log30.csv to delete!");
