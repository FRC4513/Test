...
import robot.utils.*;
import robot.utils.PositionTracker.Posn;
...
public class Drivetrain extends Subsystem {
    ...
    // PHS
    // Why is this not double the preceding?
    ...
    ***/
    ...
    public Drivetrain() {
    	// PHS: changing PositionTracker to a full fledged object
        //mPosn = new Posn() ;
        //mPosn2 = new Posn() ;
...
/*
    ...
    public void resetEncodersAndStats() {				// Set Encoders to zero
		...
		// PHS
		// anytime the encoders are reset, the position tracker needs to start over
    ...
    void calcDrivetrainSpeeds() {
        ...
        // PHS PositionTracker is now a full fledged object
        /***
        ...
        ***/        
        ...
        Posn posn = posnTracker.getPosition() ;
    ...
    // ******************************************************************
    // PHS: moving all this to a separate class file
    /***
    ...
    ***/
    ...
    void initVar() {
        ...
        mLogCoastFlag = false;
        clearPIDdata();
        // PHS: PositionTracker is now an object
        // initPosition() ;
        posnTracker.init();
    }
    ...
    // PHS: this is now part of an external class
    // ******************************************************************
